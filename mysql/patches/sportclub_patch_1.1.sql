...
SET SPEED_RANKING = null, TECHNICAL_RANKING = null
WHERE (SPEED_RANKING is not null OR TECHNICAL_RANKING is not null)
  AND (DIFFICULTY NOT IN ('Svart', 'Blå', 'Lila', 'Violett') OR EVENT_ID IN (SELECT EVENT_ID FROM RACE_EVENT WHERE SPORT_CODE != 'OL' OR RACE_DISTANCE = 'Sprint'));
