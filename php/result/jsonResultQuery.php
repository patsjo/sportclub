...
elseif ($iType == "POINTS")
{
  $sql = "SELECT RACE_EVENT_RESULTS.COMPETITOR_ID, FIRST_NAME, LAST_NAME, GENDER, BIRTHDAY, " .
    ...
    "   GROUP_CONCAT(LEAST(RANKING, 90.0) SEPARATOR ',') AS RANKING," .
    "   GROUP_CONCAT(LEAST(SPEED_RANKING, 90.0) SEPARATOR ',') AS SPEED_RANKING," .
    "   GROUP_CONCAT(LEAST(TECHNICAL_RANKING, 90.0) SEPARATOR ',') AS TECHNICAL_RANKING," .
    "   GROUP_CONCAT(LEAST(RANKING_RELAY, 90.0) SEPARATOR ',') AS RANKING_RELAY " .
