...
const GetGaussEasterSunday = year => {
  ...
  let easterSunday = moment(`${year.toString()}-03-22`, "YYYY-MM-DD");
...
export const GetDates = (startDate, numberOfDates, t) => {
  const dates = [];
