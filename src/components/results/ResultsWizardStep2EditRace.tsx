        ...
        if (eventRace) {
          ...
          raceEvent = {
            ...
            longitude: eventRace.EventCenterPosition
              ...
              : null,
            latitude: eventRace.EventCenterPosition ? parseFloat(eventRace.EventCenterPosition['@attributes'].y) : null,
            results: [],
            teamResults: [],
            ...
            if (classResult.PersonResult != null) {
              const personResults: IEventorPersonResult[] = Array.isArray(classResult.PersonResult)
                ...
                : classResult.PersonResult.RaceResult == null ||
                  classResult.PersonResult.RaceResult.EventRaceId === raceWizardModel.selectedEventorRaceId?.toString()
              ...
              if (raceWizardModel.overwrite) {
                ...
                for (let j = 0; j < clubPersonResults.length; j++) {
                    ...
                    competitor = await AddMapCompetitorConfirmModal(
                      ...
                      personResult.Person.PersonId,
                      {
                        ...
                        iEventorCompetitorId:
                          typeof personResult.Person.PersonId !== 'string' || personResult.Person.PersonId.length === 0
                            ? null
                            : personResult.Person.PersonId,
                      },
                  ...
                  const position =
                    valid && personResult.Result?.ResultPosition ? parseInt(personResult.Result.ResultPosition) : null;
                  const secondTime =
                    valid &&
                    nofStartsInClass &&
                    nofStartsInClass > 1 &&
                  ...
                  if (totalIofResults && totalIofResults.ClassResult) {
                    ...
                    if (totalPersonResult) {
                      ...
                      resultMultiDay = {
                        ...
                        totalTime:
                          totalValid && totalPersonResult.Time ? ConvertSecondsToTime(totalPersonResult.Time) : null,
                        totalWinnerTime:
            ...
            if (classResult.TeamResult != null) {
              const preTeamResults = Array.isArray(classResult.TeamResult)
                ...
                : classResult.TeamResult.RaceResult == null ||
                  classResult.TeamResult.RaceResult.EventRaceId === raceWizardModel.selectedEventorRaceId?.toString()
              ...
              for (let j = 0; j < clubTeamMemberResults.length; j++) {
                ...
                const totalStagePosition =
                  stageOk && teamMemberResult.OverallResult?.ResultPosition
                    ...
                    : null;
                const totalStageTimeBehind = stageOk ? GetTimeWithHour(teamMemberResult.OverallResult?.TimeDiff) : null;
                ...
                if (leg > 1 && stageOk) {
                  ...
                  const prevStagePosition =
                    prevOverallResult && prevOverallResult.ResultPosition
                      ...
                      : null;
                  const prevStageTimeBehind = prevOverallResult ? GetTimeWithHour(prevOverallResult.TimeDiff) : null;
                  deltaPositions =
                    totalStagePosition && prevStagePosition ? totalStagePosition - prevStagePosition : null;
                  deltaTimeBehind = prevStageTimeBehind ? TimeDiff(prevStageTimeBehind, totalStageTimeBehind) : null;
                }
            ...
            if (classResult.TeamResult != null && classResult.TeamResult.length > 0) {
              ...
              const legInfos = Array.from(Array(numberOfLegs).keys())
                ...
                .map((leg) => {
                  ...
                  const winnerTime = legWinner?.Result?.Time ? ConvertSecondsToTime(legWinner.Result.Time) : undefined;
                  const secondsPerKilometer =
                    winnerTime && lengthInMeter
                      ? GetSecondsWithFractionsPerKiloMeter(winnerTime, lengthInMeter)
                      : undefined;
              ...
              for (let j = 0; j < clubTeamMemberResults.length; j++) {
                ...
                const raceTeamResult: IRaceTeamResultProps = {
                  ...
                  teamFailedReason: teamDidNotStart
                    ...
                    : null,
                  competitorTime:
                    valid && teamMemberResult.Result?.Time ? ConvertSecondsToTime(teamMemberResult.Result.Time) : null,
