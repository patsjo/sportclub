...
const varendgn: IMobxClubModelSnapshotIn = {
  ...
  loginUrl: 'https://www.varendgn.se/log_in.php',
  logoutUrl: 'https://www.varendgn.se/log_out.php',
  attachmentUrl: 'https://www.varendgn.se/showfile.php?iFileID=',
  titleLogo: {
  ...
  logo: {
    url: 'https://www.varendgn.se/images/icons/vgn.png',
    width: 300,
    height: 300,
  },
  theme: {
